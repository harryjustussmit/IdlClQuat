...
intrinsic WeakEquivalenceClassesWithPrescribedOrder(O::AlgAssVOrd : Side:="Left") -> List
{
  ...
  method:="IntermediateIdealsWithTrivialExtensionAndPrescribedOrder";
  // method:="IntermediateIdealsWithPrescribedOrder"; //for debug
  ...
  classes:=[* *];
  if method eq "IntermediateIdealsWithTrivialExtensionAndPrescribedOrder" then
      ///////////////////////////////////////////////
      // Using IntermediateIdealsWithTrivialExtensionAndPrescribedOrder
      if  Side eq "Right" then
          candidates:=IntermediateIdealsWithTrivialExtensionAndPrescribedRightOrder(O,1*T,ff,T);
      ...
      if Side eq "Left" then
          candidates:=IntermediateIdealsWithTrivialExtensionAndPrescribedLeftOrder(O,1*T,ff,T);
          for I in candidates do
            if not exists{ J : J in classes | IsWeaklyEquivalent(I,J : Side:=Side)} then
                Append(~classes,I);
            end if;
  ...
  if method eq "IntermediateIdealsWithPrescribedOrder" then
      ///////////////////////////////////////////////
      ...
      if Side eq "Left" then
          candidates:=IntermediateIdealsWithPrescribedLeftOrder(O,1*T,ff);
          for I in candidates do
            if not exists{ J : J in classes | IsWeaklyEquivalent(I,J : Side:=Side)} then
                Append(~classes,I);
            end if;
